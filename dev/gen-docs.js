...
var WEIGHT_DESC = {
  ...
  unitOnBoard: 'Value of each of my deployed units (× what that piece is worth to the search).',
  unitValueBase: 'What a piece is worth to the search OVER its bounty — the premium for what it can still do. A piece is priced `worth + this`, so a new unit type needs no price of its own.',

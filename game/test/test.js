/* Frozen-API path (CLAUDE.md): game/test.js now DELEGATES to the subsystem test
   ...
   The order below is for a reader, not for the tests: a house's contract test
   registers its fixture room on an engine of its own (test.helpers' freshEngine),
   so no suite can see another's fixture and any order is green. */
'use strict';

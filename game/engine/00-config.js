...
(function (global) {
  ...
  // engine/05-ai.js, via this same helper — kept out of the rules home on purpose: only
  // Engine.CONFIG.digest is stamped onto DB rows, so AI-side tuning never reshuffles the data.)

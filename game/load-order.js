...
(function (g) {
  ...
  var ENGINE = [
    ...
    'engine/01-core.js',
    'engine/board/shape.js',
    'engine/board/shapes/rows.js',
    'engine/board/shapes/hexes.js',
    'engine/board/board.js',
    'engine/03-rules.js',
  ...
  // Everything over the engine. A house declares itself as it loads — its seats,
  // records, actions, marks and regions — so its rooms are scheduled after its
  // base and before its door. ui/boot.js is last: it wires what belongs to no
  // house yet. The sweep worker takes sim.js only.
  var APP = [
    'sim.js',
    'report-model.js',
    'ui/chart-model.js',
    ...
    'ui/kit/kind.js',
    'ui/modals/modal.js',
    'ui/board/board-config.js',
    'ui/board/geometry.js',
    'ui/board/mark.js',
    'ui/board/marks/tile.js',
    'ui/board/marks/coord.js',
    'ui/board/marks/hq.js',
    'ui/board/marks/unit.js',
    'ui/board/marks/highlight.js',
    'ui/board/marks/ghost-hex.js',
    'ui/board/marks/edge-hit.js',
    'ui/board/marks/strike.js',
    'ui/board/marks/ring.js',
    'ui/board/marks/pill.js',
    'ui/board/marks/fallen.js',
    'ui/board/marks/struck.js',
    'ui/board/marks/fell-badge.js',
    'ui/board/marks/side-glow.js',
    ...
    'ui/board/board.js',
    'ui/session/store.js',
    'ui/session/stores/save.js',
    'ui/session/stores/dev.js',
    'ui/session/stores/battalions.js',
    'ui/session/stores/battalion.js',
    'ui/session/seat.js',
    'ui/session/seats/none.js',
    'ui/session/seats/ai.js',
    'ui/session/seats/hotseat.js',
    'ui/session/seats/net.js',
    'ui/session/seats/watch.js',
    'ui/session/snapshot.js',
    'ui/session/net.js',
    'ui/session/record.js',
    'ui/session/session.js',
    'ui/turn/turn.js',
    'ui/turn/actions/card.js',
    'ui/turn/actions/step.js',
    'ui/turn/actions/concede.js',
    'ui/turn/actions/ai.js',
    'ui/turn/hand.js',
    'ui/turn/prompt.js',
    'ui/turn/journal.js',
    'ui/turn/glossary.js',
    'ui/screens/skirmish/region.js',
    'ui/screens/skirmish/regions/topbar.js',
    'ui/screens/skirmish/regions/mats.js',
    'ui/screens/skirmish/regions/board.js',
    'ui/screens/skirmish/regions/hand.js',
    'ui/screens/skirmish/regions/prompt.js',
    'ui/screens/skirmish/regions/journal.js',

...
(function (g) {
  ...
  var ENGINE = [
    ...
    'engine/01-core.js',
    'engine/board/unit/unit-config.js',
    'engine/board/unit/unit.js',
    'engine/board/unit/infantry.js',
    'engine/board/unit/cavalry.js',
    'engine/board/unit/artillery.js',
    'engine/board/board.js',
    'engine/board/rows-outline.js',
    'engine/board/hexes-outline.js',
    'engine/03-rules.js',
  ...
  var APP = [
    ...
    'ui/board/board-marks.js',
    'ui/board/tile-mark.js',
    'ui/board/coord-mark.js',
    'ui/board/hq-mark.js',
    'ui/board/highlight-mark.js',
    'ui/board/ghost-mark.js',
    'ui/board/edge-hit-mark.js',
    'ui/board/pill-mark.js',
    'ui/board/ring-mark.js',
    'ui/board/strike-mark.js',
    'ui/board/struck-mark.js',
    'ui/board/glow-mark.js',
    'ui/board/badge-mark.js',
    'ui/board/hex-ring-mark.js',
    'ui/board/hex-hit-mark.js',
    ...
    'ui/board/unit/unit-config.js',
    'ui/board/unit/unit-marks.js',
    'ui/board/unit/infantry-mark.js',
    'ui/board/unit/cavalry-mark.js',
    'ui/board/unit/artillery-mark.js',
    'ui/board/live-board.js',
    'ui/board/thumb-board.js',
    'ui/board/map-editor.js',
    'ui/fx.js',
    'ui/skirmish.js',

...
| [[data-and-reports]]             | Where every skirmish lands (`logs/woa.db`) and how reports/skills flow |
...
| [[driving-the-balance-loop]]            | Bill's onboarding: server → skirmish → reports → DB, script + skill map |
| [[standard-runs-runbook]]               | Named apples-to-apples recipes for before/after balance comparison |

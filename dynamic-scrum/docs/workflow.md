...
- Aesthetic: steampunk Napoleonic field journal (see `../../specs/original-specs/Player Card Art direction drafts.md`, prompts in `../../specs/original-specs/art-prompts.md`) — parchment, brass, earthy tones; no modern UI chrome.

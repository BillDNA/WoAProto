...
5. ==**You would know it with the name filed off.**== Against its peers across the Catalog, does this Card ask a draft decision the others don't — or is it a stat-block a shipped Card already owns? Judge the decision it poses, not its win-rate (that's the sweep's). The finding names the Card it shadows and the pick-moment this one could own instead.

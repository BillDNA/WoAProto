...
| How a concept LOOKS | that household's `.css`, imported at the top of `game/style.css` | `ui/hex/hex.css`, `ui/board/terrain/terrain.css`; `style.css` keeps the page — chrome, layout, screens, shared palette |
